...
│   │   │   ├── widgets
```
> *The above structure is roughly based on [this great article series](https://codewithandrea.com/articles/flutter-app-architecture-riverpod-introduction/)
> on Riverpod architecture by Andrea Bizzotto.*

...
To enable any Sidecar-based package (like [design_system_lints](https://pub.dev/packages/design_system_lints)) to display lints and assist recommendations within your IDE, perform the following setup steps:

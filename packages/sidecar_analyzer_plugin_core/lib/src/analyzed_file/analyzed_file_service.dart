...
//   const AnalyzedFileService(this.ref);
...
//       final unit = await ref.read(resolvedUnitProvider(file).future);
...
//         if (!_isPathIncludedForRule(rule: rule, file: file)) {
//           return Future.value([]);
//         }
...
//     final relativePath =
//         p.relative(file.path, from: file.contextRoot.root.path);
